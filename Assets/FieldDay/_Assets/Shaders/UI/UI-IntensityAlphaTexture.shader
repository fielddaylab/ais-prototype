Shader "FieldDay/UI/Intensity+Alpha Texture"
{
    Properties
    {
        [PerRendererData] [NoScaleOffset] _MainTex ("Intensity+Alpha Texture", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            {
				half4 color = LayerIntensityAlphaTexture(_MainTex, IN.texcoord, IN.color);
